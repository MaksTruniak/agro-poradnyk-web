...
const PESTICIDE_TYPES = [
  ...
  { slug: 'adjuvant',             name: "Ад'юванти",           emoji: '🔬' },
  { slug: 'bio_product',          name: 'Біопрепарати',        emoji: '🍃' },
...
// Виключені типи (добрива/насіння — окремі сторінки)
const EXCLUDE_TYPES = ['fertilizer', 'seed', 'liquid_complex_fertilizer']
...
const load = async () => {
  ...
  const data = await api.getProducts({
    ...
    excludeTypes: activeType.value ? [] : EXCLUDE_TYPES,
    limit: LIMIT,
