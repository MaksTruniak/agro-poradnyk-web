    ...
    <template v-else>
      ...
      <template v-else>
        <div class="card text-center py-16">
          ...
          <p class="text-agro-light text-sm mb-6 max-w-sm mx-auto">Особистий менеджер, SLA і пріоритетні звернення доступні на тарифі <strong class="text-agro-dark">Бізнес Про</strong></p>
