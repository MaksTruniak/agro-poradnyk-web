...
const CATEGORIES: Record<string, { label: string; icon: string; svg: string; color: string; bg: string }> = {
  ...
  machinery:  { label: 'Техніка', icon: '🚜', color: '#f97316', bg: '#fff7ed', svg: '<path d="M2 17a4 4 0 108 0 4 4 0 00-8 0z" stroke-width="1.6"/><path d="M14 19a2 2 0 100-4 2 2 0 000 4z" stroke-width="1.6"/><path d="M10 17H6M14 17h-2M6 17V8l4-5h5l3 5v4" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 8H6M18 13h2a1 1 0 011 1v2a1 1 0 01-1 1h-2" stroke-width="1.6" stroke-linecap="round"/>' },
