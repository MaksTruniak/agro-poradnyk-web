    ...
    <section class="py-20 px-4 bg-white border-t border-agro-border">
      <div class="max-w-7xl mx-auto">
        ...
        <div v-if="cropStats.length" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          <NuxtLink v-for="c in cropStats" :key="c.crop_type" to="/farmers"
...
const features = [
  ...
  { icon: '🛒', title: 'Каталог препаратів', desc: 'Тисячі препаратів і добрив з пропозиціями продавців і доставкою' },
