      ...
      <div class="flex-1 min-w-0">
        ...
        <div v-else class="card text-center py-16">
          <div class="w-16 h-16 rounded-2xl bg-[rgb(238,241,227)] flex items-center justify-center mx-auto mb-4">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="rgb(47,82,51)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M2 22l10-10"/><path d="M16 8c0-4-3-6-7-6C5 2 2 7 2 12c0 0 4-1 7-4 1.5 3 5 6 9 6 0-2-1-5-2-6z"/></svg>
          </div>
