...
- Name: registration.spec.ts >> Вхід >> некоректний email при вході показує тост
- Location: tests/e2e/registration.spec.ts:148:3
...
Locator: getByText('Введіть коректний email')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Введіть коректний email')
