...
- Name: registration.spec.ts >> Валідація форми реєстрації >> email автоматично lowercase
- Location: tests/e2e/registration.spec.ts:77:3
...
Call log:
  - waiting for getByTestId('reg-email')
