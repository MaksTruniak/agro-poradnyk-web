...
- Name: registration.spec.ts >> Валідація форми реєстрації >> маска телефону форматує введення
- Location: tests/e2e/registration.spec.ts:70:3
...
Call log:
  - waiting for getByTestId('reg-phone')
