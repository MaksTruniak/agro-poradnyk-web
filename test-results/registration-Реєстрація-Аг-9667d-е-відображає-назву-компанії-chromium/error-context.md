...
- Name: registration.spec.ts >> Реєстрація: Агроном >> відображає "Регіон роботи", не відображає назву компанії
- Location: tests/e2e/registration.spec.ts:108:3
...
Locator: getByTestId('reg-region')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('reg-region')
